  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        const response = await fetch("http://localhost:8080/api/v1/aipg", {
          method: 'POST',
          headers: {
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        Create Your Vision and share with your community
        </h1>
      </div>
      ...
      <form className="mt-12 max-w-3xl" onSubmit={handleSubmit}>
        <div className=" flex flex-col gap-5">
          ...
          <div className="relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center">
            {form.photo ? (
              ...
              src={preview}
              alt="preview"
              className="9/12 h-9/12 object-contain opacity-40"
              />
            )}
        ...
        <div className="mt-10">
          <p className="mt-2 text-[#666e75] text-[14px]">once you have created the image you want, you can share it with others in the commmunity</p>
